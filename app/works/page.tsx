		...
		<div className="container mx-auto relative">
			...
			<section className=" py-10 ">
				<div className="flex md:flex-row flex-col gap-12">
					<div className="md:w-1/2 w-screen flex flex-col justify-center">
						<h1 className="font-black lg:text-3xl text-2xl mb-4 z-10">
							STARTUP COMMUNITY
						</h1>
					...
					<div className="md:w-1/2 w-screen">
						<Image
							className="object-cover object-center rounded w-3/4 mx-auto md:w-full"
							alt="hero"
