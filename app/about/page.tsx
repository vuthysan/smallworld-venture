	...
	return (
		<div className="overflow-hidden relative text-gray-600">
			<section className="body-font container mx-auto">
				<div className="md:py-20 py-4 grid md:grid-cols-2 grid-cols-1 overflow-hidden">
					<Image
						radius="md"
						alt="hero"
						className="w-full"
					...
					<div className="relative h-[100%]">
						...
						<div className="h-[100%] border-white border-2 relative bg-white/80 backdrop-blur-lg p-6 rounded-lg">
							<h2 className="font-black md:text-4xl text-3xl mb-3">
							...
							<div className="grid md:grid-cols-3 grid-cols-2 md:gap-12 gap-4 text-2xl">
			...
			<div className="bg-[url('/images/mission-back.jpg')] md:h-screen h-full w-screen ">
				<div className="bg-slate-950/80 backdrop-blur-xl text-white">
					<section className="container mx-auto">
						<div className="md:h-screen h-full flex justify-center items-center flex-col md:py-0 py-20">
							<h2 className="md:text-2xl font-bold">Mission</h2>
							<p className="md:text-6xl text-2xl md:w-[75%] text-center font-black md:my-8 my-3">
			...
			<div className="container mx-auto pt-10 mt-10">
				<h2 className="text-center font-bold md:text-5xl text-3xl mb-3">
					Our <span className="font-black text-primary">Portfolios</span>
				</h2>
				<p className="md:w-1/2 w-full mx-auto text-center text-lg mb-12">
			...
			<div className="container mx-auto py-10">
				<h2 className="text-center font-bold md:text-5xl text-3xl mb-3 mt-4">
					<span className="font-black text-primary">Investments</span>
				</h2>
				<p className="md:w-1/2 w-full mx-auto text-center md:text-lg text-md mb-12">
			...
			<div className="container mx-auto">
				<h2 className="text-center font-bold md:text-5xl text-3xl mb-3 mt-8">
					Board of <span className="font-black text-primary">Directors</span>
				</h2>
				<p className="md:w-[50%] w-screen mx-auto text-center text-lg mb-12">
					We are honored to have courageous and insightful business and
					community leaders to serve on our Board of Directors.
				</p>

				<div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 flex-wrap gap-4 md:mb-20 mb-8">
				...
				<div className="container mx-auto">
					...
					<p className="md:w-1/2 w-full mx-auto text-center text-lg md:mb-12 mb-5">
						We are especially pleased to have built strategic partnerships with
						forward-thinking leaders in the business world.
					</p>

					<div className="flex max-w-4xl md:gap-x-20 gap-x-5 gap-y-3 mx-auto items-center justify-between">
						<Image
